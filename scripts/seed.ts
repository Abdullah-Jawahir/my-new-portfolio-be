  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Python', level: 70, icon: 'Code2', color: 'from-cyan-500 to-teal-500', order: 4 },
        { name: 'Node.js', level: 75, icon: 'Code2', color: 'from-green-500 to-emerald-500', order: 5 },
      ],
    },
    {
      category: 'database',
      ...
      featured: true,
      skills: [
        { name: 'MySQL', level: 80, icon: 'Database', color: 'from-blue-500 to-indigo-500', order: 0 },
        { name: 'PostgreSQL', level: 70, icon: 'Database', color: 'from-purple-500 to-violet-500', order: 1 },
        { name: 'MongoDB', level: 65, icon: 'Database', color: 'from-green-500 to-emerald-500', order: 2 },
        { name: 'Firebase', level: 75, icon: 'Database', color: 'from-orange-500 to-amber-500', order: 3 },
      ],
    },
    {
      category: 'tools',
      ...
      featured: true,
      skills: [
        { name: 'Git', level: 85, icon: 'GitBranch', color: 'from-orange-500 to-red-500', order: 0 },
        { name: 'Docker', level: 65, icon: 'Code2', color: 'from-blue-500 to-cyan-500', order: 1 },
        { name: 'VS Code', level: 90, icon: 'Code2', color: 'from-blue-500 to-indigo-500', order: 2 },
        { name: 'Postman', level: 80, icon: 'Code2', color: 'from-orange-500 to-amber-500', order: 3 },
      ],
    },
  ];
